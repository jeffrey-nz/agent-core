...
${coderDirective}
- EXISTING FILES: NEVER use write_file on a file that already exists. Always use patch_file with the smallest search_block that uniquely identifies the target location. write_file is ONLY for new files - confirmed new by a read_file returning "not found" or "does not exist".
